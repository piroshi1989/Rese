                ...
                <div class="reservation__table">
                    ...
                    @csrf
                        ...
                        <div class= "reservation__form__inner">
                            ...
                            <p class="reservation__td">予約{{ ($reservations->currentPage())}}</p>
                        </div>
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="reservation__td">
                                    <input class="reservation__date" type="date" name="date" name="date" min="{{ $today }}" value="{{ $reservation->date }}">
                                </td>
                            </tr>
                            <tr>
            ...
            <div class= "liked__shops">
                ...
                <div class="shop__content">
                    ...
                    <div class="shop__info">
                        ...
                        <p class="shop__area">#{{ $likedShop->area->name }}</p>
                        <p class="shop__genre">#{{ $likedShop->genre->name }}</p>
